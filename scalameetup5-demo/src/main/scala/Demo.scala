...
import actors.{DefaultConstructorWorker, Supervisor, TimedWorker, Worker}
import akka.actor.{ActorRef, ActorSystem, Inbox, Props}
import akka.pattern.{ask, pipe}
import akka.util.Timeout
import messages.{Fine, Hit, Ping}
...
//    pipe(result2) to you
    ...
    val dcw1: ActorRef =
      system.actorOf(DefaultConstructorWorker.props((1, false, "dc1")), "dcw1")
    ...
    val sp: ActorRef = system.actorOf(Props[Supervisor], "sp")
